#ifndef _UART_INLINE_H_
#define _UART_INLINE_H_
...
void inline user_uart_init_boot() {
...
void inline user_uart_send_boot(unsigned int c) {
    do { asm volatile("nop"); } while (*UART0_FR & 0x20);
    *UART0_DR = c;
}


char inline user_uart_getc_boot() {
    char r;
